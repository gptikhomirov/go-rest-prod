CREATE schema go_rest_prod;

CREATE table go_rest_prod.users
(
...
CREATE table go_rest_prod.tasks
(
    id             SERIAL PRIMARY KEY,
    version        BIGINT       NOT NULL DEFAULT 1,
    ...
    author_user_id INTEGER      NOT NULL REFERENCES go_rest_prod.users (id)
);